...
const PersonalHeader = React.memo(() => {
  const { language } = useLanguageStore();

  const data = {
    name: language === 'zh' ? "欧阳陈熙" : "Chenxi Ouyang",
    role: language === 'zh' ? "南京遥察科技有限公司 执行董事、法人代表、CEO、CTO" : "Executive Director, Legal Representative, CEO & CTO, Nanjing Yaocha Technology Co., Ltd.",
...
PersonalHeader.displayName = 'PersonalHeader';
