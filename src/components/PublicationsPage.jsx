...
const PublicationsPage = () => {
  ...
  const publications = [
    ...
    },
    {
      ...
      items: [
        {
          title: '脊椎动物线粒体中的RNA设计&优化算法',
          titleEn: 'Vertebrate Mitochondrial RNA Design & Optimization Algorithm',
          details: '相关软件作品正在申请著作权保护',
          detailsEn: 'Related software works are applying for copyright protection'
        },
        {
          title: '细胞质中的线性RNA设计&优化算法',
          titleEn: 'Cytoplasmic Linear RNA Design & Optimization Algorithm',
          details: '相关软件作品正在申请著作权保护',
          detailsEn: 'Related software works are applying for copyright protection'
        },
        {
          title: 'CircuRNA 人工智能环状RNA设计平台',
          titleEn: 'CircuRNA AI Circular RNA Design Platform',
          details: '相关软件作品正在申请著作权保护',
          detailsEn: 'Related software works are applying for copyright protection'
        }
      ]
                  ...
                  {publication.items.map((item, index) => (
                    <div key={index} className="relative pl-6">
                      ...
                      <div className="flex flex-col space-y-2">
                        {item.title === 'CircuRNA 人工智能环状RNA设计平台' || item.titleEn === 'CircuRNA AI Circular RNA Design Platform' ? (
                          <a 
                            href="https://github.com/Chency-OY/Circular-RNA-Design-Platform"
                            target="_blank"
